...
```bash
git clone https://github.com/GalleryJoiner/shelly-1-gen4-matter-thread-203.git
cd shelly-1-gen4-matter-thread-203
...
Have a firmware variant or feature you'd like to see prioritized? [Vote on the roadmap discussion](https://github.com/GalleryJoiner/shelly-1-gen4-matter-thread-203/discussions) or open an issue with your use case.
...
<!-- Last updated: 2026-06-06 15:37:45 -->
